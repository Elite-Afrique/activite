...
export const appRoutes: Route[] = [
    ...
    // {path: '', pathMatch : 'full', redirectTo: 'dashboards/besoin'},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'besoin', loadChildren: () => import('app/modules/admin/dashboards/finance/finance.module').then(m => m.FinanceModule)},
            {path: 'dashboard1', loadChildren: () => import('app/modules/admin/apps/tasks/tasks.module').then(m => m.TasksModule)},
            {path: 'document', loadChildren: () => import('app/modules/admin/apps/file-manager/file-manager.module').then(m => m.FileManagerModule)},
